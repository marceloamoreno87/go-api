...
func (s *RolePermissionService) GetRolePermissions(input request.RequestGetRolePermissionInputDTO) (output []usecase.GetRolePermissionsOutputDTO, err error) {
...
func (s *RolePermissionService) CreateRolePermission(input request.RequestCreateRolePermissionInputDTO) (output usecase.CreateRolePermissionOutputDTO, err error) {
...
func (s *RolePermissionService) UpdateRolePermission(input request.RequestUpdateRolePermissionInputDTO) (output usecase.CreateRolePermissionOutputDTO, err error) {
...
func (s *RolePermissionService) DeleteRolePermissionByRoleID(input request.RequestDeleteRolePermissionByRoleIDInputDTO) (output usecase.DeleteRolePermissionByRoleIDOutputDTO, err error) {
